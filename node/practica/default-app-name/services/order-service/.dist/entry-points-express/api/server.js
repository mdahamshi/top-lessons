...
const common_express_middlewares_1 = require("@practica/common-express-middlewares");
...
function defineCommonMiddlewares(expressApp) {
    expressApp.use(common_express_middlewares_1.addRequestId);
    expressApp.use((0, helmet_1.default)());
    expressApp.use(express_1.default.urlencoded({ extended: true }));
    expressApp.use(express_1.default.json());
    expressApp.use((0, common_express_middlewares_1.jwtVerifierMiddleware)({
